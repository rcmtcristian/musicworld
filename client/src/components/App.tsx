      ...
      <section className="main--section wrapper">
        ...
        <main data-barba="container" data-barba-namespace="home">
          <section className="separator">
            ...
            <section className="subSecond--section">
              <p>
        ...
        <!-- call to action  -->
        */}
              <div className="subSecond--section--container">
                <div className="subSecond--section--container--left">
                  <p>
                    <span className="accent--style">
            ...
            <!-- button to login -->
            */}
                  <div className="subSecond--section--container--left--button">
      ...
      */}
            <div className="footer--container">
              <div className="footer--container--left">
                <p>
                  <span className="">
                    © 2023 Care UK. All rights reserved. Registered in England and Wales. Company
                    No. 03785450. Registered office: 1st Floor, 85 Victoria Street, London, SW1E
                    5JL.
                  </span>
                </p>
              </div>
              <div className="footer--container--right">
                <p>
                  <span className="">
                    Care UK is a trading name of Care UK Limited. Care UK Limited is registered in
                    England and Wales. Company No. 03785450. Registered office: 1st Floor, 85
